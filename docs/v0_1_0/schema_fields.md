...
ApexKit provides a robust typing system allowing you to define the structure, validation, and relationships of your data. This guide covers all supported field types, their validation options, and how to manage schema evolution.
...
### `URL`
*   **Description:** Validates that the input is a properly formatted web link (e.g., `https://apexkit.io`).
...
ApexKit includes a **Field History Tracker** to handle schema migrations safely.
