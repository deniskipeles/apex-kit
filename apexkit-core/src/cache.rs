...
use crate::{
    Collection, Db, Record, ai_models, auth::User, models, query::QueryOptions,
...
impl Db for CachedDb {
    ...
    async fn list_files(
        ...
        limit: i64,
        offset: i64,
    ) -> Result<Vec<models::StoredFile>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    async fn get_file_metadata(
        &self,
        id: i64,
    ) -> Result<Option<models::StoredFile>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    async fn list_scripts(
        &self,
    ) -> Result<Vec<crate::script_models::Script>, Box<dyn std::error::Error + Send + Sync>> {
        self.inner.list_scripts().await
    }
    async fn create_script(
        &self,
        req: crate::script_models::CreateScriptReq,
    ) -> Result<i64, Box<dyn std::error::Error + Send + Sync>> {
    ...
    async fn get_script_by_name(
        &self,
        name: &str,
    ) -> Result<Option<crate::script_models::Script>, Box<dyn std::error::Error + Send + Sync>>
    {
    ...
    async fn query_engine(
        &self,
        query: crate::query_engine::ApexQuery,
