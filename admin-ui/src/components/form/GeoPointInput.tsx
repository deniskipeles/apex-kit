...
export const GeoPointInput = React.forwardRef<HTMLInputElement, GeoPointInputProps>(
  ({ label, value = { lat: 0, lng: 0 }, onChange, required, error, className }, ref) => {
    ...
    return (
      <div className={`space-y-2 ${className}`}>
        <FieldLabel required={required} icon={<MapPin className="h-4 w-4" />}>
          {label}
        </FieldLabel>
