    ...
    <div className="space-y-4">
      <div className="rounded-lg border border-border bg-card overflow-hidden">
        ...
        <div className="bg-secondary/10 p-3 border-t border-border">
          <Button onClick={addField} variant="outline" size="sm" className="w-full border-dashed hover:border-primary hover:bg-primary/5 hover:text-primary transition-all">
          ...
          <div className="space-y-6 py-2">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                 <h4 className="text-sm font-medium text-foreground flex items-center gap-2">
                    Type Specific
                    <Badge variant="secondary" className="text-[10px] uppercase">{activeField.type}</Badge>
                 </h4>
                 <Separator />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                onChange={(e: any) => updateField(editingIndex, { min: e.target.value ? Number(e.target.value) : null })}
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                onChange={(e: any) => updateField(editingIndex, { max: e.target.value ? Number(e.target.value) : null })}
                            />
                        </div>
                    </div>
                 )}
