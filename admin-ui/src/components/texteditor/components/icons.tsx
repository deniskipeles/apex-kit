...
export const MagicWandIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M13.5 2.1l-.9 2.45 2.45-.9.9-2.45-2.45.9zM5.4 4l1.05 3.6 3.6 1.05-3.6 1.05-1.05 3.6-1.05-3.6-3.6-1.05 3.6-1.05L5.4 4zm13.5 13.5l.9-2.45-2.45.9-.9 2.45 2.45-.9zM20 15l-3.6-1.05L15.35 10l-1.05-3.6-3.6-1.05L7.1 9.4l-1.05 3.6-3.6 1.05 3.6 1.05L7.1 18.6l3.6 1.05 3.6-1.05L15.35 15l1.05-3.6 3.6-1.05z"></path>
  </svg>
);
...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      fill="#4CAF50"
      d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.222,0-9.655-3.344-11.303-7.962l-6.571,4.819C9.656,39.663,16.318,44,24,44z"
    ></path>
    <path
      fill="#1976D2"
...
export const BulletedListIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M4 10.5c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 12c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM8 19h12v-2H8v2zm0-6h12v-2H8v2zm0-8v2h12V5H8z"></path>
  </svg>
);
...
export const NumberedListIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M2 17h2v.5H3v1h1v.5H2v1h3v-4H2v1zm1-9h1V4H2v1h1v3zm-1 3h1.8L2 13.1v.9h3v-1H3.2L5 11.1V10H2v1zm5-6v2h12V5H7zm0 12h12v-2H7v2zm0-5h12v-2H7v2z"></path>
  </svg>
);
...
export const SuperscriptIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20.4 8.2h-2.5l-2-2.3-2 2.3h-2.5l3.5-4-3.5-4h2.5l2 2.3 2-2.3h2.5l-3.5 4 3.5 4zm-7.9 1.8h-3v3.8h-2V10H3.7v-2h3.8V4.2h2v3.8h3v2z"></path>
  </svg>
);
...
export const SubscriptIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20.4 17.8h-2.5l-2-2.3-2 2.3h-2.5l3.5-4-3.5-4h2.5l2 2.3 2-2.3h2.5l-3.5 4 3.5 4zm-7.9-1.8h-3v3.8h-2V16H3.7v-2h3.8v-3.8h2v3.8h3v2z"></path>
  </svg>
);
...
export const CodeBlockIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M4 18h16v-2H4v2zm0-4h16v-2H4v2zm0-4h16V8H4v2zm0-6v2h16V4H4z"></path>
  </svg>
);
...
export const TextColorIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M9.62 12L12 5.67 14.38 12H9.62zM11 3L5.5 17h2.25l1.12-3h6.25l1.12 3h2.25L13 3h-2zM3 19h18v2H3z" />
  </svg>
);
...
export const RedoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M18.4 10.6C16.55 9 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7l-3.6 3.6z"></path>
  </svg>
);
...
export const MarkdownIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20.5 6L16 12L11.5 6H4V18H7V11L11.5 17L16 11V18H19V6H20.5Z"></path>
  </svg>
);
