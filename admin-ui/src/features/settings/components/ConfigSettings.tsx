...
export const ConfigSettings = () => {
  ...
  const handleDelete = async (key: string) => {
    if (!confirm(`Are you sure you want to delete '${key}'? This may break system functionality.`))
      return;
    try {
      ...
      <Card>
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="ghost" size="icon" onClick={loadConfigs}>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {isJsonMode ? (
              <div className="h-[200px] border border-input rounded-md overflow-hidden">
                <JSONEditor value={formValue} onChange={setFormValue} height="100%" />
              </div>
            ) : (
          ...
          <div className="flex items-center justify-between p-3 border border-border rounded bg-secondary/5">
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] text-muted-foreground">
                Store securely using system master key.
              </p>
            </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button
              onClick={handleSave}
              isLoading={isSaving}
              disabled={!formKey || (!formValue && !editingItem)}
            >
