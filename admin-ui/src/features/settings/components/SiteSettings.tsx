...
export const SiteSettings = () => {
  ...
  const handleDelete = async (pathsToDelete: string[]) => {
    if (
      !confirm(
        `Are you sure you want to delete ${pathsToDelete.length} files/folders? This cannot be undone.`
      )
    )
      return;
        ...
        <CardContent className="space-y-6">
          ...
          <div className="rounded-lg border border-dashed border-border bg-secondary/5 p-8 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mt-1 mb-4">
              Upload a <code>.zip</code> file containing your HTML, CSS, and JS. The contents will
              be extracted to the public root.
            </p>
