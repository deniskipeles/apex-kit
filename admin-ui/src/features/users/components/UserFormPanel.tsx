...
export const UserFormPanel = ({ user, onSave, onCancel }: UserFormPanelProps) => {
  const [formData, setFormData] = useState<any>({ email: '', password: '', role: 'user', metadata: '{}' });
      ...
      <div className="relative flex h-full w-full flex-col border-l border-border bg-background shadow-2xl animate-in slide-in-from-right md:max-w-lg">
        ...
        <div className="flex-1 space-y-8 overflow-y-auto p-6">
          ...
          <div className="space-y-4">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider flex items-center gap-2">Identity</h3>
          ...
          <div className="space-y-4">
              ...
              <p className="text-[10px] text-muted-foreground">Store custom user fields (e.g. profile info, preferences).</p>
          </div>
          ...
          {/* Security */}
          <div className="space-y-4">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider flex items-center gap-2">Security</h3>
              <PasswordInput 
