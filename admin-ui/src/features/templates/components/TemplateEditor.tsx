          ...
          <div className="space-y-4 overflow-y-auto pr-2">
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-muted-foreground">
                Public URL: /render/{formData.slug || '...'}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(e: any) =>
                  setFormData({ ...formData, script_id: e.target.value || null })
                }
              >
              ...
              <p className="text-[10px] text-muted-foreground">
                Script output will be available as variables.
              </p>
            </div>
          ...
          <div className="md:col-span-2 flex flex-col h-full border-l border-border pl-0 md:pl-6">
            <div className="flex items-center justify-between mb-2">
              <Label className="flex items-center gap-2">
                <Code className="h-4 w-4" /> HTML / Tera Template
              </Label>
