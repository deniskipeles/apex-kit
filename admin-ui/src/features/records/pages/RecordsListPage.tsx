...
export const RecordsListPage = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] w-full md:flex-row bg-background/50">
       ...
       <PreviewPanel isOpen={!!previewRec} onClose={() => setPreviewRec(null)} title="Record Details" actions={<><Button className="flex-1" variant="outline" onClick={() => { setSelectedRec(previewRec); setPreviewRec(null); setViewMode('edit'); }}><Edit className="mr-2 h-4 w-4"/> Edit</Button><Button variant="destructive" size="icon"><Trash2 className="h-4 w-4"/></Button></>}>
