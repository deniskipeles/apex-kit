...
import {
    ...
    Code2, Menu, AlertTriangle, ShieldAlert, Users,
    LayoutTemplate
} from 'lucide-react';
                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            {activeTab === 'setup' && (
                                <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    <SectionHeader title="Initialization" icon={Server} description="Install the SDK and initialize the client. It automatically handles context switching for Tenants and Sandboxes." />
...
`} />
                            ...
                            {activeTab === 'records' && (
                                <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-10">
                                    <SectionHeader title="Data Operations" icon={Database} description={`Standard CRUD operations for the '${colName}' collection.`} />
                                    ...
                                    <div className="grid grid-cols-1 gap-8">
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground mb-3">Fetch records with pagination, sorting, and MongoDB-style filtering.</p>
...
console.log(res.total); // Total count
                                     `} />
                                        ...
                                        <div>
                                            <h5 className="font-bold text-sm mb-2 flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-green-500"></div> Create, Update, Delete</h5>
                                            <CodeBlock label="JS" code={`
// Get single record
...
// hits[0].score => 2.45
                                    `} />
                                        ...
                                        <div className="p-4 rounded-xl border border-purple-500/20 bg-purple-500/5">
                                            ...
                                            <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
                                                Converts query text to embeddings to find conceptually similar records. Requires text fields to have <code>vectorize: true</code>.
                                            </p>
                                            <CodeBlock label="JS" code={`
    ...
    console.log(rec.id, rec._score);
                                    ...
                                    `} />
                                        ...
                                        <div className="p-4 rounded-xl border border-pink-500/20 bg-pink-500/5">
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center gap-2">
                                                    <Badge variant="outline" className="bg-pink-500/10 text-pink-500 border-pink-500/20">Multimodal</Badge>
                                                    <h5 className="font-bold text-sm">Image Vector Search</h5>
                                                </div>
                                            </div>
                                            <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
                                                Find visually similar images by passing a Base64 image payload. Requires <code>file</code> fields to have <code>vectorize: true</code>.
                                            </p>
                                            <CodeBlock label="JS" code={`
...
console.log(response.metadata); // Grounding/Citation data (if Google Search is enabled)
                            ...
                            {activeTab === 'scripts' && (
                                <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-6">
                                    <SectionHeader title="Server Scripts" icon={Terminal} description="Trigger custom backend JavaScript logic via API endpoints." />
...
console.log(result.receipt_url); 
                            ...
                            {activeTab === 'ssr' && (
                                <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-6">
                                    <SectionHeader title="Server-Side Rendering (SSR)" icon={LayoutTemplate} description="Build dynamic pages using JavaScript Frontmatter and HTML." />

                                    <p className="text-sm text-muted-foreground mb-4">
                                        ApexKit templates use an Astro-like syntax. You can write Server-Side JavaScript inside the <code>---</code> block at the top of the file to fetch database records, and the returned JSON becomes available to the HTML below it.
                                    </p>

                                    <CodeBlock label="HTML" code={`---
    ...
    <small>Rendered for: {{ user_agent }}</small>
                             ...
                             `} />
                                    ...
                                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-12">
                                        <SectionHeader title="Server-Side Rendering (SSR)" icon={LayoutTemplate} description="Build fast, secure, and dynamic pages using JavaScript Controllers, Tera HTML, and HTMX." />

                                        {/* Part 1: Anatomy of a Template */}
                                        <div>
                                            <h5 className="font-bold text-base mb-2 text-foreground border-b border-border pb-2">1. Anatomy of a Template</h5>
                                            <p className="text-sm text-muted-foreground mb-4">
                                                A template consists of two parts: a Server-Side JavaScript Controller (wrapped in a special script tag) and Tera HTML. The JS executes securely on the backend, fetches data, and passes JSON to the HTML engine.
                                            </p>
                                            <CodeBlock label="HTML / TERA" code={`<script>
// ---@@ssr
export default async function(req) {
    const payload = await req.json();
...
<div class="container">
    ...
    <ul>
        ...
        {% endfor %}
                                        ...
                                        <div>
                                            <h5 className="font-bold text-base mb-2 text-foreground border-b border-border pb-2">2. Routing, Request, and Auth</h5>
                                            <p className="text-sm text-muted-foreground mb-4">
                                                Templates are automatically accessible at <code>/render/&#123;slug&#125;</code>.
                                                The <code>req.json()</code> object contains URL parameters, headers, and the authenticated user's details.
                                            </p>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <CodeBlock label="Request Payload" code={`{
  "params": { 
  ...
  "auth": { 
    ...
    "role": "admin" 
                                                ...
                                                <CodeBlock label="Protecting a Route" code={`// Inside your ---@@ssr block
export default async function(req) {
    const payload = await req.json();
    ...
    return { user: payload.auth };
                                        ...
                                        <div>
                                            <h5 className="font-bold text-base mb-2 text-foreground border-b border-border pb-2">3. Client-Side: <code className="text-primary">apex.js</code> and HTMX</h5>
                                            <p className="text-sm text-muted-foreground mb-4">
                                                To make your frontend work flawlessly across Root, Tenants, and Sandboxes, include the built-in <code>apex.js</code> script. It automatically manages JWT tokens, scope routing, and intercepts HTMX and <code>fetch()</code> requests to append the correct headers.
                                            </p>
                                            <CodeBlock label="base-layout template" code={`<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <button onclick="$apex.logout()">Logout</button>
                                        ...
                                        {/* Part 4: Components */}
                                        <div>
                                            <h5 className="font-bold text-base mb-2 text-foreground border-b border-border pb-2">4. Components & Includes</h5>
                                            <p className="text-sm text-muted-foreground mb-4">
                                                You can break your UI into reusable components. Note: The SSR JavaScript <b>only executes on the main requested template</b> (the Controller). The main template must fetch the data and pass it down, and the components just render the HTML.
                                            </p>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <CodeBlock label="components/navbar template" code={`<!-- No JS allowed here. Just HTML/Tera -->
<nav>
    ...
    {% endif %}
                                                ...
                                                <CodeBlock label="dashboard template" code={`<script>
// ---@@ssr
export default async function(req) {
    const payload = await req.json();
    return { user: payload.auth };
...
<div>
    ...
    <main>Dashboard Content</main>
                                        ...
                                        <div>
                                            <h5 className="font-bold text-base mb-2 text-foreground border-b border-border pb-2">5. Tera Syntax Cheat Sheet</h5>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div className="bg-secondary/10 p-4 rounded-md border border-border text-sm font-mono text-muted-foreground">
                                                    <span className="text-primary font-bold block mb-1">Variables & Filters</span>
                                                    &#123;&#123; user.email &#125;&#125;<br />
                                                    &#123;&#123; post.data.title | upper &#125;&#125;<br />
                                                    &#123;&#123; post.data.content | safe &#125;&#125; (Renders HTML)<br />
                                                    &#123;&#123; data | debug &#125;&#125; (Dumps JSON)
                                                </div>
                                                <div className="bg-secondary/10 p-4 rounded-md border border-border text-sm font-mono text-muted-foreground">
                                                    <span className="text-primary font-bold block mb-1">Logic & Loops</span>
                                                    &#123;% if user.role == "admin" %&#125; ... &#123;% endif %&#125;<br />
                                                    <br />
                                                    &#123;% for item in items %&#125;<br />
                                                    &nbsp;&nbsp;&lt;li&gt;&#123;&#123; loop.index &#125;&#125;. &#123;&#123; item.name &#125;&#125;&lt;/li&gt;<br />
                                                    &#123;% else %&#125; No items.<br />
                                                    &#123;% endfor %&#125;
                                                </div>
                                            </div>
                            ...
                            {activeTab === 'errors' && (
                                <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-8">
                                    <SectionHeader title="Error Handling" icon={AlertTriangle} description="Standardized JSON error responses across all APIs." />
                                                ...
                                                <table className="w-full text-sm text-left">
                                                    ...
                                                    <tbody className="divide-y divide-border">
                                                        <tr>
                                                            ...
                                                            <td className="px-4 py-3 text-muted-foreground">Invalid input or bad JSON syntax.</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="px-4 py-3 text-muted-foreground">Resource does not exist.</td>
                                                        </tr>
                                                        <tr>
