...
export const MainLayout = () => {
  ...
  const sandboxId = currentView.startsWith('sandbox__') 
      ? currentView.split('__')[1] 
      : null;

  if (isLoading) return <div className="flex h-screen items-center justify-center bg-background text-primary"><Loader2 className="animate-spin w-8 h-8" /></div>;
