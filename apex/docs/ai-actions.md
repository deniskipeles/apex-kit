# TinyBase AI Actions Documentation

**Version:** 2.3
**Base URL:** `http://localhost:5000/api/v1`

TinyBase **AI Actions** allow you to turn Generative AI prompts (LLMs) into standard REST API endpoints. This creates a secure "middle layer" between your frontend and AI providers (like Google Gemini/Imagen).
...
**How it works:** If you pass a variable containing a **Base64 Data URI** (e.g., `data:image/png;base64,...`), TinyBase automatically extracts the binary data and sends it to the model as an inline media attachment.
...
The availability depends on your Google Cloud/AI Studio API key permissions, but TinyBase is configured to support:
