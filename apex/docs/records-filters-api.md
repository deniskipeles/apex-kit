# TinyBase Filtering API Documentation

**Version:** 2.4
**Context:** REST API, GraphQL, and Real-time WebSockets.

TinyBase provides a unified, **MongoDB-style JSON filtering syntax**. This engine translates JSON logic into efficient SQL for database queries and performs high-speed in-memory evaluation for real-time WebSocket subscriptions.
...
Since TinyBase stores data as JSON, you can filter deeply nested properties using dot notation.
```json
{
