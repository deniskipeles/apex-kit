# TinyBase Scripting Engine Documentation

The TinyBase Scripting Engine allows you to write server-side JavaScript to extend your application logic. It runs in a secure, isolated Rust environment using the **Boa** engine.
...
### `$db` (Database Access)
Direct access to your TinyBase collections. All methods return **Promises**.
