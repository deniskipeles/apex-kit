# TinyBase Users API & Data Relationships

**Version:** 2.1
**Base URL:** `http://localhost:5000/api/v1`

In TinyBase, **Users** are a system-level entity distinct from standard Data Collections. The Users API handles authentication, identity management, and security roles.
...
3.  TinyBase compares the Token ID (`10`) with the Record's `author_id` (`10`).
