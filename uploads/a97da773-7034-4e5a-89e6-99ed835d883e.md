# TinyBase Renderer & Templating Documentation

The TinyBase Renderer is a **Hybrid Server-Side Rendering (SSR) Engine** built on top of [Tera](https://keats.github.io/tera/). It allows you to build dynamic web applications using HTML mixed with logic, seamlessly integrated with the TinyBase database and Scripting Engine.
...
TinyBase is optimized for HTMX. You can request *specific components* to update parts of a page without reloading.
