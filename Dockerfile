...
# We install gcompat and libstdc++ so our GNU binary and ONNX C++ library work on Alpine!
# We also install curl, jq, tar, and msmtp (the Alpine alternative to sendmail)
